...
#define actionDITCH 11     //LAND; ditch drainage (subruface water loss, not come back to streamflow) (bounded by non-forest cover fraction)
...
struct accumulate_patch_object
{
	...
	double sat_deficit_z_min;
	double sat_deficit_z_abv_th;
    double peakLAI;
    double meanLAI;
    double psn;
    double days;
